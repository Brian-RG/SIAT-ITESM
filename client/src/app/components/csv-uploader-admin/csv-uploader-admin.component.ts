...
@Component({
  selector: 'siat-csv-uploader-admin',
  templateUrl: './csv-uploader-admin.component.html',
  styleUrls: ['./csv-uploader-admin.component.scss'],
})
export class CsvUploaderAdminComponent implements OnInit {
