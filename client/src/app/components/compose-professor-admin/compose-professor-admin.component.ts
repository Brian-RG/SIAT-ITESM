...
@Component({
  selector: 'siat-compose-professor-admin',
  templateUrl: './compose-professor-admin.component.html',
  styleUrls: ['./compose-professor-admin.component.scss']
})
export class ComposeProfessorAdminComponent implements OnInit {
