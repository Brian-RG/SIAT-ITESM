...
@Component({
  selector: 'siat-compose-period-admin',
  templateUrl: './compose-period-admin.component.html',
  styleUrls: ['./compose-period-admin.component.scss']
})
export class ComposePeriodAdminComponent implements OnInit {
