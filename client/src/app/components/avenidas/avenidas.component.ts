...
import { ComposeAvenidasComponent } from '../compose-avenidas/compose-avenidas.component';

@Component({
  selector: 'siat-avenidas',
  templateUrl: './avenidas.component.html',
  styleUrls: ['./avenidas.component.scss']
})
export class AvenidasComponent implements OnInit {
  ...
  public createAvenue(){
    const modal = this.nzModalService.create({
      ...
      nzContent: ComposeAvenidasComponent,
      nzStyle: {width: '80vw'},
    });
